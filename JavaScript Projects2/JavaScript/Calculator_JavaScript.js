...
function Input_Decimal(dot) {
    //This ensures that accidental cllicking of the decimal point doesn't cause bugs in the operation.
...
keys.addEventListener('click', (event) => {
    ...
    const { target } = event;
    //If the element that was clickedon is not a button, exit the function.
