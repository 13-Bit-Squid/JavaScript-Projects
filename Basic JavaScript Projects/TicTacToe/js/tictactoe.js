...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //This condition checks to see of ot os computers turn.
        if(activePlayer === 'O') {
        ...
        //Returning trie is needed for our computersTurn() function to work.
        return true;
    }
    ...
    function computersTurn() {
        ...
        while(!success) {
            ...
            if (placeXOrO(pickASquare)) {
                ...
                //This changes our biilean and ends the loop.
                success = true;
            };
        }
    }
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 variables we pass are all included in our arrau true is returned and our else if condition executes the drawWinLine function.
...
//This function takes a string parameter of the path you set earlier for placemnet sound ('./media/place.mp3')
...
//This line accesses our html canvas element.
    ...
    function animateLineDrawing() {
        ...
        //This method draws our everything laid out above.
        c.stroke();
        //This condition checks if we've reached the endpoint.
        if (x1 <= x2 && y1 <= y2) {
            //This condition adds 1- to the previous end x point.
            if (x < x2) { x += 10; }
