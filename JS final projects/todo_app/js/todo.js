...
function add() {
    ...
    todos.push(task);
    /* This converts the taks input to a JSON string*/
...
function show() {
    /* This sets the taks that was retrieved as a variable*/
    var todos = get_todos();
...
function remove() {
    ...
    todos.splice(id, 1);
    localStorage.setItem('todo', JSON.stringify(todos));
    /* This looks in the show() how to diplay a removed item on the screen*/
    show();
